...
<body>
  ...
  <main>
    <div class="m-10">
      ...
      <div>
        <button class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded"><a href="../structures1.2/php1.php">selanjutnya</a></button>
      </div>
    </div>
