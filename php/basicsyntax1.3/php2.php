...
<section class="font-poppins">
  <div class="flex flex-col">
    ...
    <div class="m-auto">
      <h3 class="font-bold text-xl">PHP Statements</h3> <br>
      <p>Setiap pernyataan PHP harus diakhiri dengan titik koma</p> <br>
      ...
      <div class="m-auto px-3 py-2 bg-yellow-200 max-w-md rounded-lg">
        <p>Lupa menambahkan titik koma di akhir pernyataan menghasilkan kesalahan (ERROR).</p>
      </div> <br>
    </div>
