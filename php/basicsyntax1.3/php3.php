...
<?php
$code1 = '<?php';
$code2 = '  echo "<strong>Ini Adalah Teks Tebal</strong>";';
$code3 = '?>';
?>
<section class="font-poppins">
  <div class="flex flex-col">
    ...
    <div class="m-auto">
      <h3 class="font-bold text-xl">ECHO</h3> <br>
      <p>Markup HTML dapat ditambahkan ke teks dalam pernyataan echo .</p> <br>
      <div class="bg-black p-10 rounded-lg text-white">
        <?php
        echo htmlspecialchars($code1) . '<br>' . '<br>' . htmlspecialchars($code2) . '<br>' . '<br>' . htmlspecialchars($code3);
        ?>
      </div><br>
      <div class="m-auto px-3 py-2 bg-yellow-200 max-w-md rounded-lg">
        <p>Jalankan kode dan lihat cara kerjanya!</p>
      </div> <br>
    </div>
    <div class="text-center mx-36 mt-36">
      <button class="float-right bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded-lg"><a href="question.php?n=5">Selanjutnya</a></button>
