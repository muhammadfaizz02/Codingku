...
<section class="font-poppins">
  <div class="flex flex-col">
    ...
    <div class="m-auto">
      ...
      <p>PHP memiliki fungsi "Echo" bawaan, yang digunakan untuk menampilkan teks.
        Sebenarnya, ini bukanlah sebuah fungsi; itu konstruksi bahasa. Dengan demikian, tidak memerlukan tanda kurung.</p> <br>
      <p class="font-bold">Mari kita output teks</p> <br>
      ...
      <div class="px-3 py-2 m-auto bg-yellow-200 max-w-md rounded-lg">
        <p>Teks harus dalam tanda kutip tunggal atau ganda.</p>
      </div> <br>
    </div>
