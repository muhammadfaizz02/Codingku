...
<section class="font-poppins">
  <div class="flex flex-col">
    ...
    <div class="m-auto max-w-6xl">
      <h3 class="font-bold text-xl">COMPARISON OPERATORS</h3> <br>
      <p>Operator perbandingan tambahan:</p><br>
      <img class="rounded-lg" src="php2.jpeg"> <br>
      <div class="px-3 py-2 text-center m-auto bg-yellow-200 max-w-4xl rounded-lg">
        <p>Operator perbandingan PHP digunakan untuk membandingkan dua nilai (angka atau string).</p>
      </div> <br>
    </div>
    <div class="text-center mx-36 mt-24">
      <button class="float-right bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded-lg"><a href="question.php?n=21">Mulai</a></button>
