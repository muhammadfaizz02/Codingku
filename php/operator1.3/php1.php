...
<head>
  ...
  <title>Operators | Codingku</title>
...
<section class="font-poppins">
  <div class="flex flex-col">
    ...
    <div class="m-auto max-w-6xl">
      ...
      <p>Operator perbandingan membandingkan dua nilai (angka atau string). <br>
        Operator perbandingan digunakan di dalam pernyataan bersyarat, dan dievaluasi menjadi TRUE atau FALSE.</p><br>
      <img class="rounded-lg" src="php1.jpeg"> <br>
      <div class="px-3 py-2 text-center m-auto bg-yellow-200 max-w-4xl rounded-lg">
        <p>Hati-hati menggunakan == dan === ; yang pertama tidak memeriksa jenis data.</p>
      </div> <br>
    </div>
