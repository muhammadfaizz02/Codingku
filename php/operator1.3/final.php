...
<section class="font-poppins">
  <div class="flex flex-col">
    ...
    <div class="text-center mx-56 mt-36">
      <button class="float-right bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded-lg"><a href="../operator1.4/php1.php">Selanjutnya</a></button>
