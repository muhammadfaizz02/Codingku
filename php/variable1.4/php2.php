...
<section class="font-poppins">
  <div class="flex flex-col">
    ...
    <div class="m-auto max-w-6xl">
      <h3 class="font-bold text-xl">THE GLOBAL KEYWORD</h3> <br>
      <p>Kata kunci global digunakan untuk mengakses variabel global dari dalam suatu fungsi. <br>
        Untuk melakukannya, gunakan kata kunci global di dalam fungsi, sebelum variabel.</p><br>
    ...
    <div class="text-center mx-36 my-5">
      <button class="float-right bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded-lg"><a href="question.php?n=14">Selanjutnya</a></button>
