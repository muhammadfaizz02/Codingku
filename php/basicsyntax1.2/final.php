  ...
  <div class="flex flex-col">
    ...
    <div class="m-auto flex flex-col">
      ...
      <div class="max-w-4xl p-10 border-2 border-slate-400 rounded-lg shadow-xl">
        <p>Selamat kamu baru saja mempelajari Pengantar PHP. Jangan lupa untuk berlatih terus agar kamu semakin ahli!!</p>
    ...
    <div class="text-center mx-56 mt-36">
      <button class="float-right bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded-lg"><a href="../basicsyntax1.3/php1.php">Selanjutnya</a></button>
