  ...
  <div class="flex flex-col">
    ...
    <div class="m-auto flex flex-col">
      ...
      <div class="max-w-4xl p-10 border-2 border-slate-400 rounded-lg shadow-xl">
        <p>Selamat kamu baru saja mempelajari Comments pada PHP. Jangan lupa untuk berlatih terus agar kamu semakin ahli!!</p>
    ...
    <div class="text-center mx-56 mt-36">
      <button class="float-right bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded-lg"><a href="../operator1.1/php1.php">Selanjutnya</a></button>
      <button class="float-left bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded-lg"><a href="../../update_koin.php">Selesai</a></button>
    </div>
  </div>
</section>