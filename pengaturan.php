...
<body class="font-poppins text-white">
    <section class="bg-cover bg-right" style="background-image: url(gambar/k2.png)">
        <nav class="relative px-4 py-4 flex justify-between items-center bg-transparent">
            ...
            <a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 border-2 border-purple-500 text-white hover:bg-white hover:text-black hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-pink-500/60 hover:duration-300 text-sm font-bold  rounded-xl transition duration-75" href="login.php">Masuk</a>
            <a class="hidden lg:inline-block py-2 px-6 text-white bg-gradient-to-r from-pink-500 to-violet-500 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-pink-500/60 hover:duration-300 text-sm font-bold  rounded-xl transition duration-75" href="daftar.php">Daftar</a>
        </nav>
        <div class="navbar-menu relative z-50 hidden">
            ...
            <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
                ...
                <div class="mt-auto">
                    <div class="pt-6">
                        <a class="block px-4 py-3 mb-3 leading-loose text-center border-2 border-purple-500 text-black hover:bg-white hover:text-black shadow-lg hover:shadow-pink-500/60 hover:duration-300 text-sm font-bold  rounded-xl transition duration-75" href="login.php">Masuk</a>
                        <a class="block px-4 py-3 mb-2 leading-loose text-center text-white bg-gradient-to-r from-pink-500 to-violet-500 shadow-lg hover:shadow-pink-500/60 hover:duration-300 text-sm font-bold  rounded-xl transition duration-75" href="daftar.php">Daftar</a>
                    </div>
        ...
        <body class="font-poppins bg-cover" style="background-image: url(gambar/k2.png)">
            <section class="text-black">
                <div class="flex justify-center">
                    <div class="float-center bg-white rounded-l-lg p-10">
                    ...
                    <div class="float-right rounded-r-lg bg-slate-200 p-10">
                        <div class="p-5">
                            <p class="text-2xl mb-4 font-bold border-b border-slate-500">Akun</p>
                            <p class="text-lg mb-4 font-semibold">Profil</p>
                            <div class="flex">
                                <img src="gambar/icon/js.png" class="rounded-full bg-white w-1/12">
                                <div class="text-md px-10 py-4">
                                    <p class="font-semibold"><?= $_SESSION["username"]; ?></p>
                                    <p class="text-sm">Email@gmail.com</p>
                                    <button class="px-4 py-2 rounded-md border-purple-500 border-2 text-sm">Change Picture</button>
                                </div>
                            </div>
                        </div>
                    </div>
