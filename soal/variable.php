...
$result10 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (10)");
$result11 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (11)");
$result12 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (12)");
$result13 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (13)");
$result14 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (14)");
$result15 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (15)");
$result16 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (16)");
$result17 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (17)");
$result18 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (18)");
$result19 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (19)");
?>
...
<body class="font-poppins bg-cover bg-gray-200">
    <div class="container-fluid position-relative flex font-poppins">
        ...
        <div class="flex flex-col w-full mt-4 mx-20 bg-white rounded-lg">
            <h1 class="text-2xl text-center p-4 font-poppins font-bold">DATA SOAL VARIABLES</h1>
            <div class="mx-auto">
            ...
            <div class="w-full m-auto p-10">
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result10)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result11)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result12)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result13)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result14)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result15)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
