...
$result20 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (20)");
$result22 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (22)");
$result23 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (23)");
?>
...
<body class="font-poppins bg-cover bg-gray-200">
    <div class="container-fluid position-relative flex font-poppins">
        ...
        <div class="flex flex-col w-full mt-4 mx-20 bg-white rounded-lg">
            <h1 class="text-2xl text-center p-4 font-poppins font-bold">DATA SOAL OPERATORS</h1>
            <div class="mx-auto">
            ...
            <div class="w-full m-auto p-10">
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result17)) {
                            echo "<tr>";
                        ...
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result18)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result19)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result20)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result22)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result23)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
