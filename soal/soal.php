...
$result = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (1)");
$result2 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (2)");
$result3 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (3)");
$result4 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (4)");
$result5 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (5)");
$result6 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (6)");
$result7 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (7)");
$result9 = mysqli_query($conn, "SELECT * FROM questions WHERE question_number IN (9)");
        ...
        <div class="flex flex-col w-full mt-4 mx-20 bg-white rounded-lg">
            ...
            <div class="w-full m-auto p-10">
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result9)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['question_text'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?question_number=$user_data[question_number]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?question_number=$user_data[question_number]'>Delete</a></td></tr>";
                        }
