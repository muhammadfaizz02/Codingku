...
$result51 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (51)");
$result52 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (52)");
$result53 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (53)");
$result54 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (54)");

$result55 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (55)");
$result56 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (56)");
$result57 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (57)");

$result58 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (58)");
$result59 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (59)");
$result60 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (60)");

$result61 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (61)");
$result62 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (62)");
$result63 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (63)");

$result64 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (64)");
$result65 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (65)");
$result66 = mysqli_query($conn, "SELECT * FROM options WHERE id IN (66)");
?>
...
<body class="font-poppins bg-cover bg-gray-200">
    <div class="container-fluid position-relative flex font-poppins">
        ...
        <div class="flex flex-col w-full mt-4 mx-20 bg-white rounded-lg">
            <h1 class="text-2xl text-center p-4 font-poppins font-bold">DATA JAWABAN BASIC SYNTAX</h1>
            <div class="mx-auto">
            ...
            <div class="w-full m-auto p-10">
                <table class="w-full">
                    ...
                    <tbody>
                        <div class="px-20 py-4 text-center border font-semibold bg-slate-100">
                            <p>Soal 1</p>
                        </div>
                        <?php
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <?php
                        while ($user_data = mysqli_fetch_array($result51)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result52)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result53)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result54)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result55)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result56)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result57)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result58)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result59)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result60)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <?php
                        while ($user_data = mysqli_fetch_array($result61)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result62)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result63)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php
                        while ($user_data = mysqli_fetch_array($result64)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result65)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
                        ?>
                        <?php
                        while ($user_data = mysqli_fetch_array($result66)) {
                            echo "<tr>";
                            echo "<td class='p-4 text-sm'>" . $user_data['coption'] . "</td>";
                            echo "<td class='float-right p-4'><a class='px-4 py-2 bg-green-500 text-white rounded-lg' href='edit.php?id=$user_data[id]'>Edit</a> <a class='px-4 py-2 bg-red-500 text-white rounded-lg' href='delete.php?id=$user_data[id]'>Delete</a></td></tr>";
                        }
